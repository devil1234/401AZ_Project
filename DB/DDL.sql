...
ALTER TABLE tbl_classes 
  ...
  ADD CONSTRAINT fk_start_time_id FOREIGN KEY (start_time_day_id) REFERENCES tbl_start_time_day (start_time_day_id) ON UPDATE CASCADE ON DELETE NO ACTION,
...
ALTER TABLE tbl_enrolments
  ...
  ADD CONSTRAINT fk_student_id_2 FOREIGN KEY (student_id) REFERENCES tbl_students (student_id) ON UPDATE CASCADE ON DELETE NO ACTION;
